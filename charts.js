...
export function initCharts(analytics) {
  ...
  // Legacy wallet chart (still used on analytics page if present)
  if (walletCtx) {
  ...
  if (incomeExpenseCtx) {
    incomeExpenseChart = new Chart(incomeExpenseCtx, {
      ...
      data: {
        ...
        datasets: [{
          data: [analytics.totalIncome || 0, analytics.totalExpenses || 0],
          backgroundColor: ["rgba(52, 211, 153, 0.88)", "rgba(248, 113, 113, 0.90)"],
          borderColor: ["rgba(52,211,153,0.2)", "rgba(248,113,113,0.2)"],
          borderWidth: 2,
          hoverOffset: 8,
        }],
      },
...
function generateColors(count) {
  const baseColors = ["#63B3ED", "#34d399", "#fbbf24", "#f87171", "#a78bfa", "#22d3ee"];
